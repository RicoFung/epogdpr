...
<body>
	...
	<div align="left" class="subtitle">Politique de confidentialité</div>
	<div class="content">
		...
		<p>
			<ul class="catalog">
				<li><a href="#section1" class="catalog-link"><span class="catalog-text">1.	Identité du responsable de traitement</span><span class="catalog-pages">1</span></a></li>
				<li><a href="#section2" class="catalog-link"><span class="catalog-text">2.	Mode de collecte de vos données</span><span class="catalog-pages">1</span></a></li>
				<li><a href="#section3" class="catalog-link"><span class="catalog-text">3.	Description des traitements réalisés</span><span class="catalog-pages">1</span></a></li>
				<li><a href="#section4" class="catalog-link"><span class="catalog-text">4.	Durée de conservation de vos données</span><span class="catalog-pages">2</span></a></li>
				<li><a href="#section5" class="catalog-link"><span class="catalog-text">5.	Destinataires des données collectées</span><span class="catalog-pages">2</span></a></li>
				<li><a href="#section6" class="catalog-link"><span class="catalog-text">6.	Transferts de données hors UE</span><span class="catalog-pages">2</span></a></li>
				<li><a href="#section7" class="catalog-link"><span class="catalog-text">7.	Vos droits</span><span class="catalog-pages">2</span></a></li>
				<li><a href="#section8" class="catalog-link"><span class="catalog-text">8.	Réclamations</span><span class="catalog-pages">2</span></a></li>
				<li><a href="#section9" class="catalog-link"><span class="catalog-text">9.	Modification de la Politique de Confidentialité</span><span class="catalog-pages">2</span></a></li>
			</ul>
		</p>
		<div>
