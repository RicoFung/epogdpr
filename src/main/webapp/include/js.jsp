...
<!-- date-range-picker -->
<script src="${staticexternal}/res/AdminLTE/plugins/daterangepicker/moment.min.js"></script>
<script src="${staticexternal}/res/AdminLTE/plugins/daterangepicker/daterangepicker.js"></script>
<!-- bootstrap datepicker -->
<script src="${staticexternal}/res/AdminLTE/plugins/datepicker/bootstrap-datepicker.js"></script>
